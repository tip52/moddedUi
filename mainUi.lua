...
local newUIS = cloneref(game:GetService("UserInputService"))
...
function main:Begin(PROPS) 
    ...
    ImGui.Name = string.format("ImGui-%s", to_string(util:egg(to_string(players.LocalPlayer.UserId))))
